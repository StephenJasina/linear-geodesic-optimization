...
subdirectory_output = pathlib.PurePath(f'0.0002_50_50')
...
path_output_collated = pathlib.PurePath('..', 'outputs', 'animations', f'esnet_{epsilon}.json')

# Elements of the form
#   ((id_source, id_destination), [color_r, color_g, color_b])
# where color values are between 0 and 255
