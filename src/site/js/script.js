...
function generateGraph() {
  ...
  addVertex(null, -2.5404199604256013, 2.8934266632917294, true, name="0");
  addVertex(null, 0.5450268223649841, 1.5914153312953914, true, name="1");
  addVertex(null, 0.20061518453916474, 3.3942541716154895, true, name="2");
  addVertex(null, 0.6031750106663352, 3.983225919507778, true, name="3");
  addVertex(null, 2.293955130864088, -4.489836250705816, true, name="4");
  addVertex(null, -0.07373026774492346, -4.496144784750481, true, name="5");
  addVertex(null, 1.0724850949812226, 2.115549368173056, true, name="6");
  addVertex(null, 0.4300666781751421, 3.70302186569053, true, name="7");
  addVertex(null, -0.5947685698972858, 2.6056874160322434, true, name="8");
  addVertex(null, 0.2346749636591985, 0.37877489826515165, true, name="9");
  addVertex(null, -2.538473678131272, 2.8932514262349325, true, name="10");
  addVertex(null, -0.4963271688614731, 3.198339142117251, true, name="11");
  addVertex(null, -0.1292415720814608, -4.412030997488267, true, name="12");
  addVertex(null, 0.21707208729815267, 3.3783075994470266, true, name="13");
  addVertex(null, -1.1306667115151916, -0.013756108958510326, true, name="14");
  addVertex(null, -1.0001208094125484, -2.6761327128643475, true, name="15");
  addVertex(null, -0.9248010562845088, 2.1590081582585308, true, name="16");
  addVertex(null, 2.5458686779997786, 0.038990245137171455, true, name="17");
  addVertex(null, 0.9864034460140249, 4.5, true, name="18");
  addVertex(null, -0.8679987725804023, -3.7711890807842825, true, name="19");
  addVertex(null, -0.8952609063138001, -3.79572226873576, true, name="20");
  addVertex(null, 0.2215837920272869, 3.373751435970326, true, name="21");
  addVertex(null, 0.8683171378995601, 1.5982495765104439, true, name="22");
  addVertex(null, -1.1131470272174955, -3.5924472828520813, true, name="23");
  addVertex(null, -0.21446690354938322, -2.9582643743063537, true, name="24");
  addVertex(null, 0.18710164840761254, 3.38391518526451, true, name="25");
  addVertex(null, -2.5419768680892627, 2.900260908506784, true, name="26");
  addVertex(null, 0.5194831610800228, 3.8708989661013637, true, name="27");
  addVertex(null, 0.5683059497451244, 3.9006892657567316, true, name="28");
  addVertex(null, 0.21684653556902672, 3.3784828365038244, true, name="29");
  addVertex(null, -1.1279564155763102, -0.020765591230358305, true, name="30");
  addVertex(null, -0.931335553799827, 2.1644405070192176, true, name="31");
  addVertex(null, -0.8679987725804023, -3.770663369613893, true, name="32");
  addVertex(null, -0.13564319338160533, -4.450933624097043, true, name="33");
  addVertex(null, 0.6189034504994289, 3.972886933156796, true, name="34");
  addVertex(null, 2.2910956414816464, -4.486156272513095, true, name="35");
  addVertex(null, -0.1378500737124897, -4.456365972857725, true, name="36");
  addVertex(null, 0.8382357776516868, 3.997069646994684, true, name="37");
  addVertex(null, 0.21639544168064756, 3.378658073560622, true, name="38");
  addVertex(null, -1.0908062189501977, -0.032856948149303594, true, name="39");
  addVertex(null, 2.2910956414816464, -4.4858057983994994, true, name="40");
  addVertex(null, 0.2213581764645978, 3.373400961856732, true, name="41");
  addVertex(null, -0.1883072554961122, 2.8617087560116037, true, name="42");
  addVertex(null, -0.8682102662475278, -3.7711890807842825, true, name="43");
  addVertex(null, 1.115474977042892, 3.1298214529099084, true, name="44");
  addVertex(null, -0.465191422759332, 3.1299966899667058, true, name="45");
  addVertex(null, 0.8760822416012912, 1.5964972059424833, true, name="46");
  addVertex(null, 0.42846644215920354, 3.7803014077376886, true, name="47");
  addVertex(null, 0.5385794019005509, 2.9268969411398187, true, name="48");
  addVertex(null, 0.7301560107115957, 0.15394575439552946, true, name="49");
  addVertex(null, -0.1601230658439343, -4.407299596954768, true, name="50");
  addVertex(null, 0.22113256409509566, 3.373751435970326, true, name="51");
  addVertex(null, 0.20129116143823092, 0.2590879884732947, true, name="52");
  addVertex(null, 0.2218094107833188, 3.373751435970326, true, name="53");
  addVertex(null, 0.3798515811342499, -1.445267625927298, true, name="54");
  addVertex(null, -0.1801651832655018, -4.388198757763975, true, name="55");
  addVertex(null, 0.19678518901209727, 0.34880936155298803, true, name="56");
  addVertex(null, -0.12946235897231517, -4.412030997488267, true, name="57");
  addVertex(null, 0.21504223656299906, 3.3788333106174155, true, name="58");
  addVertex(null, 0.9034096347177145, 1.5372670807453388, true, name="59");
  addVertex(null, -0.15813956028921533, -4.4067738857843795, true, name="60");
  addVertex(null, -0.062428124593747754, -4.5, true, name="61");
  addVertex(null, -1.1214918016523578, -0.024796043536671065, true, name="62");
  addVertex(null, -1.1321259374971446, -0.00884947136821394, true, name="63");
  addVertex(null, 2.2910956414816464, -4.484053427831537, true, name="64");
  addVertex(null, -0.07771740134644103, 3.38198757763975, true, name="65");
  addVertex(null, 0.4307525437549454, 1.8554975758873793, true, name="66");
  addVertex(null, 0.18980344184035627, 3.4557623785509826, true, name="67");
  addVertex(null, -1.1344187748768177, -0.010251367822582836, true, name="68");
  addVertex(null, 2.2625337628710125, -4.4770439455596875, true, name="69");
  addVertex(null, 1.010845578585108, 2.3626336182558063, true, name="70");
  addVertex(null, 0.3796236974080014, -1.4435152553593344, true, name="71");
  addVertex(null, -0.9266984119848342, 2.159183395315328, true, name="72");
  addVertex(null, -1.0009606098548431, -2.6761327128643475, true, name="73");
  addVertex(null, -2.5458686779997786, 2.900436145563581, true, name="74");
  addVertex(null, -0.867787276418922, -3.767859576705156, true, name="75");
  addVertex(null, 0.21459119370204677, 3.3783075994470266, true, name="76");
  addVertex(null, -0.07373026774492346, -4.4963200218072785, true, name="77");
...
function createMap() {
  ...
  var map = new ol.Map({
        ...
        view: new ol.View({
          center: ol.proj.fromLonLat([-96.73, 38.051568086026975]),
          resolution: 40075016.68557849 / 2000 / 3.1542670223329887
        })
  });
  return map
}
