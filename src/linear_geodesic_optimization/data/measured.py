...
def sphere_north_america(mesh):
    city_id_to_index = {}
    s_indices = []
    with open(os.path.join('linear_geodesic_optimization', 'data', 'locations.csv')) as locations_file:
    ...
    with open(os.path.join('linear_geodesic_optimization', 'data', 'latencies.csv')) as locations_file:
